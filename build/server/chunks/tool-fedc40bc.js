...
const BeginningOfDay = (options = {}) => {
  ...
  const dt = new Date(
    1e3 * Math.floor((date - hour * 36e5 - minute * 6e4 - second * 1e3) / 1e3)
  );
  return dt.getTime() / 1e3;
};

export { BeginningOfDay as B, GetNowTimestampUTC as G, GetMinuteStartTimestampUTC as a, GetMinuteStartNowTimestampUTC as b };
//# sourceMappingURL=tool-fedc40bc.js.map
