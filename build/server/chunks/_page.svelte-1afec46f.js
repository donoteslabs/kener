...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${$$result.head += `<!-- HEAD_svelte-1mhmdxl_START -->${$$result.title = `<title>Kener Documentation</title>`, ""}<!-- HEAD_svelte-1mhmdxl_END -->`, ""} <section class="mx-auto mt-8 scroll-smooth rounded-3xl md:container">${validate_component(Card, "Card.Root").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(Card_content, "Card.Content").$$render($$result, { class: "px-1" }, {}, {
        default: () => {
          return `<div class="grid grid-cols-5 gap-4"><div class="sticky top-0 col-span-5 hidden max-h-screen overflow-y-auto border-r-2 border-secondary pr-1 pt-2 md:col-span-1 md:block">${each(sideBar, (item) => {
            return `${validate_component(Root, "Accordion.Root").$$render($$result, {}, {}, {
              default: () => {
                return `${validate_component(Accordion_item, "Accordion.Item").$$render($$result, { value: item.id }, {}, {
                  default: () => {
                    return `${validate_component(Accordion_trigger, "Accordion.Trigger").$$render($$result, { class: "pl-2 pr-3 text-sm font-semibold" }, {}, {
                      default: () => {
                      ...
                      default: () => {
                        return ` <ul class="pl-6 text-sm font-medium">${each(item.children, (child) => {
          ...
          })}</div> <div class="col-span-5 md:col-span-4"><div class="p-0 pt-6 md:p-10"><article id="markdown" class="prose prose-stone max-w-none dark:prose-invert prose-code:rounded prose-code:py-[0.2rem] prose-code:font-mono prose-code:text-sm prose-code:font-normal dark:prose-pre:bg-neutral-900"><!-- HTML_TAG_START -->${html}<!-- HTML_TAG_END --></article></div></div></div>`;
        }
      })}`;
    }
  })} </section>`;
...
//# sourceMappingURL=_page.svelte-1afec46f.js.map
