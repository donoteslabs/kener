...
import { I as Incident, C as Card_header, a as Card_title, b as Card_description } from './incident-747ae33c.js';
import 'clsx';
        ...
        return `${validate_component(Card_header, "Card.Header").$$render($$result, {}, {}, {
          default: () => {
            return `${validate_component(Card_title, "Card.Title").$$render($$result, {}, {}, {
              ...
              default: () => {
                return `${category.description ? `${escape(category.description)}` : ``} <a href="${escape(base, true) + "/category-" + escape(category.name, true)}" class="${escape(buttonVariants({ variant: "secondary" }), true) + " absolute -top-4 right-2"}">View</a> `;
              }
            })} `;
          }
        })} `;
...
//# sourceMappingURL=_page.svelte-84b8757d.js.map
